...
**Module:** PROG6212 — Programming 2B — POE (100 marks)
**Author:** Somila
...
You don't need to write the files from scratch each time — since you already
have the finished versions in this zip, you can build each commit by adding
one section/table/paragraph at a time to the file, saving, then staging and
committing just that piece, until the file matches its final version by the
last commit that touches it.
